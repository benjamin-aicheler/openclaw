...
EXTRA_MOUNTS="${OPENCLAW_EXTRA_MOUNTS:-openclaw_cache:/var/tmp/openclaw-compile-cache}"
HOME_VOLUME_NAME="${OPENCLAW_HOME_VOLUME:-openclaw_home}"
RAW_SANDBOX_SETTING="${OPENCLAW_SANDBOX:-}"
SANDBOX_ENABLED=""
DOCKER_SOCKET_PATH="${OPENCLAW_DOCKER_SOCKET:-}"
TIMEZONE="${OPENCLAW_TZ:-Europe/Berlin}"
...
export OPENCLAW_DOCKER_APT_PACKAGES="${OPENCLAW_DOCKER_APT_PACKAGES:-git curl jq libnspr4 libnss3 libatk1.0-0 libatk-bridge2.0-0 libdbus-1-3 libcups2 libxkbcommon0 libatspi2.0-0 libxcomposite1 libxdamage1 libxfixes3 libxrandr2 libgbm1 libasound2 xvfb}"
